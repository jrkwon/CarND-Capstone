'''
Changed: 1/22/2019 by Kwon
- The current folder is assumed at models/research
- The data folder name is changed to 'data-vatsal'
...
def main(_):
    ...
    INPUT_YAML = "../../data-vatsal/site_training_data/site_data_annotations.yaml"
